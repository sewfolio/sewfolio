    ...
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.card}>
          ...
          <TextInput style={styles.input} placeholder="Washed linen" placeholderTextColor={colors.mutedText} />

          <Text style={styles.label}>Yardage</Text>
          <TextInput style={styles.input} placeholder="3.0 yards" placeholderTextColor={colors.mutedText} />

          <Text style={styles.label}>Type</Text>
          <TextInput style={styles.input} placeholder="Linen, cotton, wool..." placeholderTextColor={colors.mutedText} />

          <Text style={styles.label}>Color</Text>
          <TextInput style={styles.input} placeholder="Oatmeal, navy, floral..." placeholderTextColor={colors.mutedText} />
