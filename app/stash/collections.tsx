...
export default function StashCollectionsScreen() {
  const { stashCollections, addStashCollection, updateStashCollection, deleteStashCollection } = useSewfolio();
  ...
  function saveEdit() {
    ...
    updateStashCollection(editingId, editingTitle.trim());
    setEditingId("");
    setEditingTitle("");
  }
    ...
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.header}>
          ...
          <Text style={styles.heading}>Stash Collections</Text>
          <View style={styles.spacer} />
        </View>

        <View style={styles.card}>
          <Text style={styles.title}>Create a collection</Text>
          <Text style={styles.body}>Sort fabric by style, brand, project type, color, or whatever makes sense.</Text>

          <TextInput
            style={styles.input}
            placeholder="Florals, solids, Tula Pink, scraps..."
            placeholderTextColor={colors.mutedText}
            value={newTitle}
            onChangeText={setNewTitle}
          />

          <Pressable onPress={createCollection} style={styles.button}>
            <Text style={styles.buttonText}>Add Collection</Text>
          </Pressable>
        </View>

        <Text style={styles.sectionTitle}>Current Collections</Text>
            ...
            {editingId === item.id ? (
              ...
              <>
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles.rowSub}>Custom fabric group</Text>
                </View>
                ...
                <View style={styles.actions}>
                  ...
                  <Pressable onPress={() => deleteStashCollection(item.id)} style={styles.deleteButton}>
